...
class SearchQuery(object):
    ...
    def __init__(self, query_string):
        if 'text:'  in query_string:
            query_string = query_string.replace('text:','').replace('*','')
    ...
    def _split_query(self, q):
        ...
        if self._isEnglish(q):
            ...
            preprocessed = (w for w in q.split())
...
class SearchSuggestionsPlugin(plugins.SingletonPlugin):
    ...
    def update_config(self, config_):
        ...
        config_['thaigdc.discovery.extension_update_date'] = '2023-06-06'
    ...
    def get_actions(self):
        from .action import search_suggest_action, search_term_list, search_term_delete
        return {
